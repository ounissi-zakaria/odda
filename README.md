...
- **Drive Chrome** — open, navigate, run JS, screenshot (optionally annotated with every Ref's box + label), and interact with the page by accessibility-tree refs.
